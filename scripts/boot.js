...
(function (window, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    define('highway',['backbone', 'underscore'], function (Backbone, _) {
